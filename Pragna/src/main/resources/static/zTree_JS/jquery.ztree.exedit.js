    ...
    _view = {
      addEditBtn: function (setting, node) {
        ...
        $$(node, consts.id.EDIT, setting).bind('click',
          function () {
			  var newName = prompt("Enter the new name:", node.name);
            if (newName) {
                editNodeAjax(node, newName); // Call the editNodeAjax function
            }
        ...
        $$(node, consts.id.REMOVE, setting).bind('click',
          function () {
			  if (confirm("Are you sure you want to delete this node?")) {
                deleteNodeAjax(node); // Call the deleteNodeAjax function
            }
